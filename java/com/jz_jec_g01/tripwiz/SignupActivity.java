...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genderGroup = findViewById(R.id.radioGroupAge);
...
/*************************Spinner***************************/
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String passError = "^[0-9a-zA-Z]+^\\d{8,20}$$";
                String nameError = "^[a-zA-Z]+^\\d{1,14}$$";
                ...
                if (!email.matches(mailFormat)) {
                    Toast.makeText(getApplicationContext(), "メールアドレスが正しく記入されていません", Toast.LENGTH_SHORT).show();
                    inputEmail.setText("");
                } else if(!passError.matches(mailFormat)) {
                    Toast.makeText(getApplicationContext(), "パスワードが正しく記入されていません", Toast.LENGTH_SHORT).show();
                    inputPassword.setText("");
                } else if(!nameError.matches(mailFormat)) {
                    Toast.makeText(getApplicationContext(), "名前が正しく記入されていません", Toast.LENGTH_SHORT).show();
